    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col lg:flex-row lg:items-end lg:justify-between mb-12 gap-8">
            ...
            <div class="flex flex-wrap gap-4 bg-white p-4 rounded-3xl shadow-sm border border-gray-100 items-center">
                <form class="flex flex-wrap gap-4 w-full sm:w-auto" method="GET" action="marketplace">
                    <div class="relative min-w-[140px]">
                        <select name="type" class="appearance-none block w-full pl-4 pr-10 py-3 bg-gray-50 border-none focus:ring-2 focus:ring-brand-primary/20 sm:text-sm rounded-xl cursor-pointer">
                    ...
                    <div class="relative min-w-[140px]">
                        <select name="category" class="appearance-none block w-full pl-4 pr-10 py-3 bg-gray-50 border-none focus:ring-2 focus:ring-brand-primary/20 sm:text-sm rounded-xl cursor-pointer">
                    ...
                    <button type="submit" class="bg-brand-primary text-white px-8 py-3 rounded-xl hover:bg-brand-dark transition-all shadow-md shadow-brand-primary/20 text-sm font-bold flex items-center gap-2">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
            ...
            <div class="group relative bg-white rounded-[2.5rem] shadow-sm border border-gray-100 overflow-hidden hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 flex flex-col">
                <!-- Image Container -->
                <div class="relative h-64 overflow-hidden p-4">
                    <div class="w-full h-full rounded-[2rem] overflow-hidden relative">
                        <img src="<?php echo htmlspecialchars($item['image_url']); ?>" alt="Hewan" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110">
                        <div class="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                        
                        <!-- Badges -->
                        <div class="absolute top-4 left-4 flex flex-col gap-2">
                            <div class="bg-brand-primary text-white text-[10px] font-black px-3 py-1.5 rounded-full shadow-lg uppercase tracking-widest">
                ...
                <div class="px-8 pb-8 pt-2 flex-grow flex flex-col">
                    <div class="flex justify-between items-start mb-4">
                        <div>
                            <h3 class="text-2xl font-black text-gray-900 capitalize leading-tight"><?php echo htmlspecialchars($item['type']); ?></h3>
                            <div class="flex items-center gap-2 mt-1">
                                <span class="w-2 h-2 rounded-full bg-emerald-500"></span>
                                <span class="text-xs font-bold text-emerald-600 uppercase tracking-tighter">Tersedia & Sehat</span>
                            </div>
                        </div>
                        <div class="text-right">
                            <p class="text-[10px] text-gray-400 font-bold uppercase tracking-widest mb-1">Mulai Dari</p>
                    ...
                    <div class="flex flex-wrap gap-2 mb-8">
                        ...
                        <div class="inline-flex items-center gap-1.5 px-3 py-1.5 bg-orange-50/50 rounded-lg text-[10px] font-black text-orange-600 border border-orange-200/50">
                            <i class="fas fa-calendar-alt opacity-60"></i> <?php echo htmlspecialchars($item['age']); ?> BLN
                        </div>
                    </div>
                    
                    <a href="/lautan-ternak-pantura/livestock/detail/<?php echo htmlspecialchars($item['id']); ?>" class="w-full inline-flex justify-center items-center gap-3 bg-brand-primary text-white py-4 px-6 rounded-2xl hover:bg-brand-dark transition-all font-bold shadow-lg shadow-brand-primary/20 group/btn overflow-hidden relative">
            ...
            <?php if(empty($livestocks)): ?>
                <div class="col-span-full text-center py-24 bg-white rounded-[3rem] shadow-sm border border-gray-100">
